...
<body>
	<div class="wrap">
		<div class="page-content">
			...
			<form action="/addProfileNaver.do" method="post">
				<table id="joinFrm">
					<!-- 모델에서 받아온 데이터 -->
				...
				<div class="checkbox_group">
					...
					<div class="agree1 astyle">
						<p>
							<span class="chk1"> 
							<input type="checkbox" id="allChk" style="width: 18px; height: 18px; padding-top: 15px;">
							</span> 
					...
					<div class="agree2 astyle">
						<h3>[필수] 이용약관 동의</h3>
						<div class="aContent">
							<textarea>
    제1조(목적)
    이 약관은 리브레드 회사(전자상거래 사업자)가 운영하는 더브레드블루사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
    ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
    
    제2조(정의)
    ① “몰”이란 더브레드블루 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
    ② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
    ③ ‘회원’이라 함은 “몰”에 회원등록을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
    ④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.
    
    제3조 (약관 등의 명시와 설명 및 개정)
    ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 더브레드블루 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
    ...
    부 칙(시행일) 이 약관은 2021년 03월 24일부터 시행합니다. 
                        </textarea>
						</div>
						<p class="aCheck">
							<span>이용약관에 동의하십니까?</span> 
							<input type="checkbox" class="normal ness"> <label>동의함</label>
						</p>
					</div>
					<div class="agree3 astyle">
    ...
    ** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한 내용을 반영하여 사용하시기 바랍니다. **
    ...
    2. 수집하는 개인정보 항목 : 이름 , 로그인ID , 비밀번호 , 자택 전화번호 , 휴대전화번호 , 이메일, 배송 주소지, 공동현관 비밀번호
    ...
    선택 약관에 동의하지 않으셔도 회원가입은 가능하며, 회원가입 후 회원정보수정 페이지에서 언제든지 수신여부를 변경하실 수 있습니다.
						...
						<p class="aCheck">
							<span>SMS 수신을 동의하십니까?</span> <input type="checkbox"
								class="normal"> <label>동의함</label><br> 
							<span>이메일 수신을 동의하십니까?</span> <input type="checkbox" class="normal"> 
							<label>동의함</label>
						</p>
					</div>
				</div>
				<div id="joinUs">
					<input type="submit" value="회원가입" id="joinme">
				</div>
			</form>
		</div>
	</div>
...
$("#joinme").on("click",function(){
	const addr1 = $("#addr").val();
	const addr2 = $("#addr1").val();
	const addr3 = $("#addr2").val();
	//데이터를 보내줄 객체 (memberAddr)
	const memberAddr = $("#mAddr").val("("+addr1+")"+" "+addr2+" "+addr3);
});
